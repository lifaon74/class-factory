import { GenerateClassTypedConstructorInterface } from './class-definition-generator';
...
export function OptionalLines<T>(variable: T | undefined, lines: (variable: T) => string[]): string[] {

...
import { TIteratorNextFunction } from '../../../../build-in/iterator/sync/iterator-types';
...
export type TIteratorPrivateContextFromGSelf<GSelf extends TGenericIteratorStruct> = IIteratorPrivateContext<
  TInferIteratorStructGValue<GSelf>,
